...
#define AES_VAL(j,k) ((j)*256+(k))
		...
		AES_128_CFB = AES_VAL(4, 16),
		AES_192_CFB = AES_VAL(4, 24),
		AES_256_CFB = AES_VAL(4, 32),
		AES_128_CFB8 = AES_VAL(5, 16),
		AES_192_CFB8 = AES_VAL(5, 24),
		AES_256_CFB8 = AES_VAL(5, 32),
		AES_128_OFB = AES_VAL(6, 16),
		AES_192_OFB = AES_VAL(6, 24),
		AES_256_OFB = AES_VAL(6, 32),
