...
int main(int argc, char* argv[])
{
	...
	try
	{
		parameters
			...
			.Add("aes-128-cfb", NULL, "Sets cipher mode to AES/CFB/PKCS5Padding key=16 iv=16.", &MyCryptographyUtilityApplication::SetAes128Cfb)
			.Add("aes-192-cfb", NULL, "Sets cipher mode to AES/CFB/PKCS5Padding key=24 iv=16.", &MyCryptographyUtilityApplication::SetAes192Cfb)
			.Add("aes-256-cfb", NULL, "Sets cipher mode to AES/CFB/PKCS5Padding key=32 iv=16.", &MyCryptographyUtilityApplication::SetAes256Cfb)
