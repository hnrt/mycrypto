...
CALL .\checkup.bat ..\plaintext44.txt tmp\plaintext44.ccm
...
CALL .\checkup.bat ..\plaintext6570.txt tmp\plaintext6570.ccm
...
CALL .\checkup.bat ..\plaintext2M.jpg tmp\plaintext2M.ccm
