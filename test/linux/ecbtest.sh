...
./checkup.sh ../plaintext44.txt tmp/plaintext44.ecb || exit 2
...
./checkup.sh ../plaintext6570.txt tmp/plaintext6570.ecb || exit 4
...
./checkup.sh ../plaintext2M.jpg tmp/plaintext2M.ecb || exit 6
