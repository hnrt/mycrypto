...
cmp ../plaintext44.txt tmp/plaintext44.cbc || exit 2
...
cmp ../plaintext6570.txt tmp/plaintext6570.cbc || exit 4
...
cmp ../plaintext2M.jpg tmp/plaintext2M.cbc || exit 6
