...
cmp ../plaintext44.txt tmp/plaintext44.ccm || exit 2
...
cmp ../plaintext6570.txt tmp/plaintext6570.ccm || exit 4
...
cmp ../plaintext2M.jpg tmp/plaintext2M-0.ccm || exit 9
...
cmp ../plaintext2M.jpg tmp/plaintext2M.ccm || exit 6
