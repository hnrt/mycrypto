...
$command aes-256-ccm -d -i ciphertext44.ccm -o plaintext44-1.ccm -p $pp -aad 123$aad && exit 12
...
$command aes-256-ccm -e -i ../plaintext2M.jpg -o ciphertext2M-0.ccm -p $pp -iv $nonce7
...
$command aes-256-ccm -d -i ciphertext2M.ccm -o plaintext2M-1.ccm -p $pp -aad ${aad}123 && exit 7
